# <img src="https://github.com/user-attachments/assets/19801c01-9ab6-4b41-bc3e-fb0af4230a96" width="40" align="center" alt="Ícone DriverWatch" /> Sistema de Segurança Veicular (Edge Computing) 
...
1. Clone este repositório em sua máquina local:
    ...
    ```bash
    git clone https://github.com/Thalles-JG-Silva/driverwatch.git
    ```
